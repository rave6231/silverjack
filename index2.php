    ...
    <body>
        ...
        <?php
           ...
           echo "<br/>";
            ...
            echo "<img src ='img/cards/".generateRandomSuit()."/$nums1.png'>";
            
            echo "<span class= 'SymbolStyle'>*</span>";
                
            echo "<img src ='img/cards/".generateRandomSuit()."/$nums2.png'>";
            ...
            {
                echo "<img src ='img/cards/".generateRandomSuit()."/".  $productsStr[$k]  . ".png'>";
